...
- `supabase/schema_and_seed.sql` — database, RLS, Realtime and 96-player seed

## 1. Supabase
Your Supabase project is already configured in `config.js`. In the Supabase SQL Editor, run `supabase/schema_and_seed.sql` once.
